...
<button type="button" id="week_1_toggle" class="week_control_button">Week 1 (28-May to 30-May)</button>
...
<button type="button" id="week_4_toggle" class="week_control_button">Week 4 (16-Jun to 20-Jun)</button>
...
<button type="button" id="week_7_toggle" class="week_control_button">Week 7 (7-Jul to 11-Jul)</button>
